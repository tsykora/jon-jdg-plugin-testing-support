...
//        manager.defineConfiguration("___default", configQueryIndexer.build());
        ...
        // some initial puts, these puts will cause:d
...
//        System.out.println("fcs dist put");
//        cinval.put("key1", "value1");
//        System.out.println("cinval put");
